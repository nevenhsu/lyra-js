...
import { DepositProcessedEvent as AvalonDepositProcessedEvent, DepositQueuedEvent as AvalonDepositQueuedEvent } from '../contracts/avalon/typechain/AvalonLiquidityPool';
import { WithdrawProcessedEvent as AvalonWithdrawProcessedEvent, WithdrawQueuedEvent as AvalonWithdrawQueuedEvent } from '../contracts/avalon/typechain/AvalonLiquidityPool';
import { TradeEvent as AvalonTradeEvent } from '../contracts/avalon/typechain/AvalonOptionMarket';
import { PositionUpdatedEvent as AvalonPositionUpdatedEvent, TransferEvent as AvalonTransferEvent } from '../contracts/avalon/typechain/AvalonOptionToken';
import { DepositProcessedEvent as NewportDepositProcessedEvent, DepositQueuedEvent as NewportDepositQueuedEvent } from '../contracts/newport/typechain/NewportLiquidityPool';
import { WithdrawProcessedEvent as NewportWithdrawProcessedEvent, WithdrawQueuedEvent as NewportWithdrawQueuedEvent } from '../contracts/newport/typechain/NewportLiquidityPool';
import { TradeEvent as NewportTradeEvent } from '../contracts/newport/typechain/NewportOptionMarket';
import { PositionUpdatedEvent as NewportPositionUpdatedEvent, TransferEvent as NewportTransferEvent } from '../contracts/newport/typechain/NewportOptionToken';
