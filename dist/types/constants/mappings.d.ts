import { AvalonLiquidityPool, AvalonLiquidityToken, AvalonLyraRegistry, AvalonOptionGreekCache, AvalonOptionMarket, AvalonOptionMarketPricer, AvalonOptionMarketViewer, AvalonOptionToken, AvalonShortCollateral, AvalonShortPoolHedger, AvalonSynthetixAdapter, AvalonTestFaucet } from '../contracts/avalon/typechain';
import { LyraStakingModule, Multicall3, MultiDistributor } from '../contracts/common/typechain';
import { NewportGMXAdapter, NewportGMXFuturesPoolHedger, NewportLiquidityPool, NewportLiquidityToken, NewportLyraRegistry, NewportOptionGreekCache, NewportOptionMarket, NewportOptionMarketPricer, NewportOptionMarketViewer, NewportOptionToken, NewportShortCollateral, NewportTestFaucet } from '../contracts/newport/typechain';
...
export type LyraContractMap<V extends Version, C extends LyraContractId> = V extends Version.Avalon ? LyraAvalonContractMap[C] : V extends Version.Newport ? LyraNewportContractMap[C] : never;
...
export type LyraMarketContractMap<V extends Version, C extends LyraMarketContractId> = V extends Version.Avalon ? LyraMarketAvalonContractMap[C] : V extends Version.Newport ? LyraMarketNewportContractMap[C] : never;
