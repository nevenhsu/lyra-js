...
export type MarketParametersStructOutput = NAvalonOptionMarketViewer.MarketParametersStructOutput | NNewportOptionMarketViewer.MarketParametersStructOutput;
export type MarketViewWithBoardsStructOutput = NAvalonOptionMarketViewer.MarketViewWithBoardsStructOutput | NNewportOptionMarketViewer.MarketViewStructOutput;
export type BoardViewStructOutput = NAvalonOptionMarketViewer.BoardViewStructOutput | NNewportOptionMarketViewer.BoardViewStructOutput;
export type StrikeViewStructOutput = NAvalonOptionMarketViewer.StrikeViewStructOutput | NNewportOptionMarketViewer.StrikeViewStructOutput;
