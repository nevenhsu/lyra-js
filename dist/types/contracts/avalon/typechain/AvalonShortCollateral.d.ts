...
export interface AvalonShortCollateralInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "LPBaseExcess" | "LPQuoteExcess" | "acceptOwnership" | "boardSettlement" | "init" | "nominateNewOwner" | "nominatedOwner" | "owner" | "routeLiquidationFunds" | "sendBaseCollateral" | "sendQuoteCollateral" | "settleOptions" | "updateDelegateApproval"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "boardSettlement", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "routeLiquidationFunds", values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        OptionToken.LiquidationFeesStruct
    ]): string;
    encodeFunctionData(functionFragment: "sendBaseCollateral", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "sendQuoteCollateral", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
...
export interface AvalonShortCollateral extends BaseContract {
    ...
    functions: {
        ...
        boardSettlement(amountBase: PromiseOrValue<BigNumberish>, amountQuote: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        init(_optionMarket: PromiseOrValue<string>, _liquidityPool: PromiseOrValue<string>, _optionToken: PromiseOrValue<string>, _synthetixAdapter: PromiseOrValue<string>, _quoteAsset: PromiseOrValue<string>, _baseAsset: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        routeLiquidationFunds(trader: PromiseOrValue<string>, liquidator: PromiseOrValue<string>, optionType: PromiseOrValue<BigNumberish>, liquidationFees: OptionToken.LiquidationFeesStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        sendBaseCollateral(recipient: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        sendQuoteCollateral(recipient: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        settleOptions(positionIds: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        boardSettlement(amountBase: PromiseOrValue<BigNumberish>, amountQuote: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber
        ] & {
            lpBaseInsolvency: BigNumber;
        ...
        init(_optionMarket: PromiseOrValue<string>, _liquidityPool: PromiseOrValue<string>, _optionToken: PromiseOrValue<string>, _synthetixAdapter: PromiseOrValue<string>, _quoteAsset: PromiseOrValue<string>, _baseAsset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        nominateNewOwner(_owner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        nominatedOwner(overrides?: CallOverrides): Promise<string>;
        owner(overrides?: CallOverrides): Promise<string>;
        routeLiquidationFunds(trader: PromiseOrValue<string>, liquidator: PromiseOrValue<string>, optionType: PromiseOrValue<BigNumberish>, liquidationFees: OptionToken.LiquidationFeesStruct, overrides?: CallOverrides): Promise<void>;
        sendBaseCollateral(recipient: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        sendQuoteCollateral(recipient: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        settleOptions(positionIds: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
        updateDelegateApproval(overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "BaseExchangedAndQuoteSent(address,uint256,uint256)"(recipient?: PromiseOrValue<string> | null, amountBase?: null, quoteReceived?: null): BaseExchangedAndQuoteSentEventFilter;
        BaseExchangedAndQuoteSent(recipient?: PromiseOrValue<string> | null, amountBase?: null, quoteReceived?: null): BaseExchangedAndQuoteSentEventFilter;
        "BaseSent(address,uint256)"(receiver?: PromiseOrValue<string> | null, amount?: null): BaseSentEventFilter;
        BaseSent(receiver?: PromiseOrValue<string> | null, amount?: null): BaseSentEventFilter;
        "BoardSettlementCollateralSent(uint256,uint256,uint256,uint256,uint256,uint256)"(amountBaseSent?: null, amountQuoteSent?: null, lpBaseInsolvency?: null, lpQuoteInsolvency?: null, LPBaseExcess?: null, LPQuoteExcess?: null): BoardSettlementCollateralSentEventFilter;
        BoardSettlementCollateralSent(amountBaseSent?: null, amountQuoteSent?: null, lpBaseInsolvency?: null, lpQuoteInsolvency?: null, LPBaseExcess?: null, LPQuoteExcess?: null): BoardSettlementCollateralSentEventFilter;
        "OwnerChanged(address,address)"(oldOwner?: null, newOwner?: null): OwnerChangedEventFilter;
        OwnerChanged(oldOwner?: null, newOwner?: null): OwnerChangedEventFilter;
        "OwnerNominated(address)"(newOwner?: null): OwnerNominatedEventFilter;
        OwnerNominated(newOwner?: null): OwnerNominatedEventFilter;
        "PositionSettled(uint256,address,address,uint256,uint256,uint8,uint256,uint256,uint256)"(positionId?: PromiseOrValue<BigNumberish> | null, settler?: PromiseOrValue<string> | null, optionOwner?: PromiseOrValue<string> | null, strikePrice?: null, priceAtExpiry?: null, optionType?: null, amount?: null, settlementAmount?: null, insolventAmount?: null): PositionSettledEventFilter;
        PositionSettled(positionId?: PromiseOrValue<BigNumberish> | null, settler?: PromiseOrValue<string> | null, optionOwner?: PromiseOrValue<string> | null, strikePrice?: null, priceAtExpiry?: null, optionType?: null, amount?: null, settlementAmount?: null, insolventAmount?: null): PositionSettledEventFilter;
        "QuoteSent(address,uint256)"(receiver?: PromiseOrValue<string> | null, amount?: null): QuoteSentEventFilter;
        QuoteSent(receiver?: PromiseOrValue<string> | null, amount?: null): QuoteSentEventFilter;
    };
    estimateGas: {
        LPBaseExcess(overrides?: CallOverrides): Promise<BigNumber>;
        LPQuoteExcess(overrides?: CallOverrides): Promise<BigNumber>;
