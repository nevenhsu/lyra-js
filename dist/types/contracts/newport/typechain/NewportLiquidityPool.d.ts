...
export interface NewportLiquidityPoolInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "lockPutCollateral", values: [
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>
    ]): string;
...
export interface NewportLiquidityPool extends BaseContract {
    ...
    functions: {
        ...
        lockCallCollateral(amount: PromiseOrValue<BigNumberish>, spotPrice: PromiseOrValue<BigNumberish>, freeLiquidity: PromiseOrValue<BigNumberish>, strikeId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        lockPutCollateral(amount: PromiseOrValue<BigNumberish>, freeLiquidity: PromiseOrValue<BigNumberish>, strikeId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        sendShortPremium(recipient: PromiseOrValue<string>, amountContracts: PromiseOrValue<BigNumberish>, premium: PromiseOrValue<BigNumberish>, freeLiquidity: PromiseOrValue<BigNumberish>, reservedFee: PromiseOrValue<BigNumberish>, isCall: PromiseOrValue<boolean>, strikeId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        insolventSettlementAmount(overrides?: CallOverrides): Promise<BigNumber>;
        liquidationInsolventAmount(overrides?: CallOverrides): Promise<BigNumber>;
        lockCallCollateral(amount: PromiseOrValue<BigNumberish>, spotPrice: PromiseOrValue<BigNumberish>, freeLiquidity: PromiseOrValue<BigNumberish>, strikeId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        lockPutCollateral(amount: PromiseOrValue<BigNumberish>, freeLiquidity: PromiseOrValue<BigNumberish>, strikeId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        lockedCollateral(overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            quote: BigNumber;
            base: BigNumber;
        }>;
        ...
        sendShortPremium(recipient: PromiseOrValue<string>, amountContracts: PromiseOrValue<BigNumberish>, premium: PromiseOrValue<BigNumberish>, freeLiquidity: PromiseOrValue<BigNumberish>, reservedFee: PromiseOrValue<BigNumberish>, isCall: PromiseOrValue<boolean>, strikeId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
