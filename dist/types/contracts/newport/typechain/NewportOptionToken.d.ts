...
export interface NewportOptionToken extends BaseContract {
    ...
    functions: {
        ...
        init(_optionMarket: PromiseOrValue<string>, _greekCache: PromiseOrValue<string>, _shortCollateral: PromiseOrValue<string>, _exchangeAdapter: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getPositionWithOwner(positionId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<OptionToken.PositionWithOwnerStructOutput>;
        getPositionsWithOwner(positionIds: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<OptionToken.PositionWithOwnerStructOutput[]>;
        init(_optionMarket: PromiseOrValue<string>, _greekCache: PromiseOrValue<string>, _shortCollateral: PromiseOrValue<string>, _exchangeAdapter: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        isApprovedForAll(owner: PromiseOrValue<string>, operator: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
