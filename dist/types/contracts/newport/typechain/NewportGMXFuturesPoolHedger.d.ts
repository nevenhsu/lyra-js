...
export interface NewportGMXFuturesPoolHedgerInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getRemainingLongLiquidityDollars", values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "getRemainingShortLiquidityDollars", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getRemainingLongLiquidityDollars", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getRemainingShortLiquidityDollars", data: BytesLike): Result;
...
export type PositionNotUpdatedEventFilter = TypedEventFilter<PositionNotUpdatedEvent>;
...
export interface NewportGMXFuturesPoolHedger extends BaseContract {
    ...
    functions: {
        ...
        canHedge(arg0: PromiseOrValue<BigNumberish>, increasesPoolDelta: PromiseOrValue<boolean>, arg2: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        getRemainingLongLiquidityDollars(spotPrice: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber] & {
            remainingDollars: BigNumber;
        }>;
        getRemainingShortLiquidityDollars(overrides?: CallOverrides): Promise<[BigNumber] & {
            remainingDollars: BigNumber;
        }>;
    ...
    filters: {
        ...
        "PositionNotUpdated(tuple)"(currentPos?: null): PositionNotUpdatedEventFilter;
        ...
        "PositionUpdated(int256,int256,uint256,bool)"(currentNetDelta?: null, expectedNetDelta?: null, modifiedDelta?: null, isIncrease?: null): PositionUpdatedEventFilter;
        PositionUpdated(currentNetDelta?: null, expectedNetDelta?: null, modifiedDelta?: null, isIncrease?: null): PositionUpdatedEventFilter;
    ...
    estimateGas: {
        ...
        canHedge(arg0: PromiseOrValue<BigNumberish>, increasesPoolDelta: PromiseOrValue<boolean>, arg2: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        cancelPendingOrder(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        canHedge(arg0: PromiseOrValue<BigNumberish>, increasesPoolDelta: PromiseOrValue<boolean>, arg2: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        cancelPendingOrder(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        ...
        getRemainingLongLiquidityDollars(spotPrice: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getRemainingShortLiquidityDollars(overrides?: CallOverrides): Promise<PopulatedTransaction>;
