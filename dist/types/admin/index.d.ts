...
export declare class Admin {
    ...
    globalContract(contractId: LyraGlobalContractId): import("../contracts/common/typechain").LyraStakingModule | import("../contracts/common/typechain").MultiDistributor | import("../contracts/common/typechain").Multicall3;
    ...
    setAdapterMarketPricingParams(marketAddressOrName: string, params: Partial<AdminAdapterMarketPricingParams>): Promise<{
        params: {
            ...
            sort(compareFn?: ((a: BigNumber, b: BigNumber) => number) | undefined): import("../contracts/newport/typechain/NewportGMXAdapter").GMXAdapter.MarketPricingParamsStructOutput;
            ...
            fill(value: BigNumber, start?: number | undefined, end?: number | undefined): import("../contracts/newport/typechain/NewportGMXAdapter").GMXAdapter.MarketPricingParamsStructOutput;
            copyWithin(target: number, start: number, end?: number | undefined): import("../contracts/newport/typechain/NewportGMXAdapter").GMXAdapter.MarketPricingParamsStructOutput;
