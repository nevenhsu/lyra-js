...
export default class Lyra {
    ...
    allPositions(options?: PositionFilter): Promise<Position[]>;
    ...
    leaderboard(options?: PositionLeaderboardFilter): Promise<PositionLeaderboard[]>;
    ...
    admin(): Admin;
    claimRewards(address: string, tokenAddresses: string[]): Promise<PopulatedTransaction>;
    lyraStaking(): Promise<LyraStaking>;
    lyraStakingAccount(address: string): Promise<import("./lyra_staking").LyraStakingAccount>;
    claimableStakingRewards(address: string): Promise<BigNumber>;
    globalRewardEpochs(): Promise<GlobalRewardEpoch[]>;
    latestGlobalRewardEpoch(): Promise<GlobalRewardEpoch | null>;
    accountRewardEpochs(address: string): Promise<AccountRewardEpoch[]>;
}
