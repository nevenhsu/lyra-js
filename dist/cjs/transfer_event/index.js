...
var TransferEvent = /** @class */ (function () {
    function TransferEvent(lyra, transfer) {
        this.lyra = lyra;
    ...
    // Getters
    TransferEvent.getByHash = function (lyra, transactionHashOrReceipt) {
