...
var Admin = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        owner = _a.sent();
                        calldata = exchangeAdapter.interface.encodeFunctionData('setMarketPricingParams', [
                            market.address,
                            toParams,
                        ]);
                        tx = (0, buildTx_1.default)(this.lyra.provider, this.lyra.provider.network.chainId, exchangeAdapter.address, owner, calldata);
    ...
    Admin.prototype.setAdapterMarketConfigurationParams = function (marketAddressOrName, params) {
        return __awaiter(this, void 0, void 0, function () {
            var market, marketAdapterConfig, fromParamsFlat, toParams, exchangeAdapter, owner, calldata, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lyra.market(marketAddressOrName)];
                    case 1:
                        ...
                        marketAdapterConfig = market.params.adapterView.config;
                        fromParamsFlat = {
                        ...
                        toParams = __assign(__assign({}, fromParamsFlat), params);
                        exchangeAdapter = (0, getLyraContract_1.default)(this.lyra, __1.Version.Newport, contracts_1.LyraContractId.ExchangeAdapter);
                        return [4 /*yield*/, exchangeAdapter.owner()];
                    case 2:
                        owner = _a.sent();
                        calldata = exchangeAdapter.interface.encodeFunctionData('setMarketAdapterConfiguration', [
                            market.address,
    ...
    Admin.prototype.setFuturesPoolHedgerParams = function (marketAddressOrName, params) {
        return __awaiter(this, void 0, void 0, function () {
            var market, futuresPoolHedger, toParams, calldata, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lyra.market(marketAddressOrName)];
                    case 1:
                        ...
                        calldata = market.lyra.network === __1.Network.Optimism
                            ? futuresPoolHedger.interface.encodeFunctionData('setFuturesPoolHedgerParams', [toParams])
                            : futuresPoolHedger.interface.encodeFunctionData('setFuturesPoolHedgerParams', [toParams]);
                        tx = (0, buildTx_1.default)(this.lyra.provider, this.lyra.provider.network.chainId, futuresPoolHedger.address, market.params.owner, calldata);
                        tx.gasLimit = bignumber_1.BigNumber.from(10000000);
                        return [2 /*return*/, { params: toParams, tx: tx }];
                }
            });
