...
var _1 = require(".");
function getQuoteDisabledReason(option, spotPrice, size, premium, newIv, newSkew, newBaseIv, isBuy, isForceClose, priceType, isOpen) {
    ...
    if (hedgerView &&
        ...
        !(0, canHedge_1.default)((0, getQuoteSpotPrice_1.default)(market, priceType), market.params.netDelta, option, size, increasesPoolDelta, hedgerView, poolHedgerParams)) {
    ...
    if (adapterView && !isForceClose && (priceType === getQuoteSpotPrice_1.PriceType.MAX_PRICE || priceType === getQuoteSpotPrice_1.PriceType.MIN_PRICE)) {
        var forceMaxSpotPrice = adapterView.gmxMaxPrice, forceMinSpotPrice = adapterView.gmxMinPrice;
        ...
        var varianceThreshold = adapterView.marketPricingParams.priceVarianceCBPercent;
