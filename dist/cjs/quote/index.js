...
var Quote = /** @class */ (function () {
    ...
    Quote.prototype.getFields = function (option, isBuy, size, options) {
        ...
        var disabledReason = (0, getQuoteDisabledReason_1.default)(option, spotPrice, size, premium, fairIv, skew, baseIv, isBuy, isForceClose, priceType, isOpen, this.lyra.network);
        if (disabledReason) {
