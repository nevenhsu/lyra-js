    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    data = (_e.sent()).data;
                    withdrawalQueuedEvents = (_b = (_a = data === null || data === void 0 ? void 0 : data.lpuserLiquidities[0]) === null || _a === void 0 ? void 0 : _a.pendingDepositsAndWithdrawals.map(function (queuedWithdrawal) {
                        return {
                            withdrawer: owner,
                            beneficiary: owner,
                            withdrawalQueueId: ethers_1.BigNumber.from(queuedWithdrawal.queueID),
                            amountWithdrawn: ethers_1.BigNumber.from(queuedWithdrawal.pendingAmount),
                            totalQueuedWithdrawals: bn_1.ZERO_BN,
                            timestamp: ethers_1.BigNumber.from(queuedWithdrawal.timestamp),
                            transactionHash: queuedWithdrawal.transactionHash,
                        };
                    })) !== null && _b !== void 0 ? _b : [];
                    withdrawalProcessedEvents = (_d = (_c = data === null || data === void 0 ? void 0 : data.lpuserLiquidities[0]) === null || _c === void 0 ? void 0 : _c.depositsAndWithdrawals.map(function (processedWithdrawal) {
                        return {
                            caller: owner,
                            beneficiary: owner,
                            withdrawalQueueId: bn_1.ZERO_BN,
                            ...
                            totalQueuedWithdrawals: bn_1.ZERO_BN,
                            timestamp: ethers_1.BigNumber.from(processedWithdrawal.timestamp),
...
exports.default = fetchAllLiquidityWithdrawalEventDataByOwner;
