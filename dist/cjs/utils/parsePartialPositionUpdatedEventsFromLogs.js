...
function parsePartialPositionUpdatedEventsFromLogs(logs, network) {
    ...
    (0, getLyraMarketContract_1.getMarketContractABI)(lyra_1.Version.Newport, contracts_2.LyraMarketContractId.OptionToken, network));
