...
function fetchTradeListener(lyra, callback, options) {
    ...
    var timeout;
    var optionMarket = new contracts_1.Contract(bn_1.ZERO_ADDRESS, (0, getLyraMarketContract_1.getMarketContractABI)(lyra.version, __1.LyraMarketContractId.OptionMarket));
