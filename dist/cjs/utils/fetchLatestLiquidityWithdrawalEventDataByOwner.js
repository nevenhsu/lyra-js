...
var BLOCK_LIMIT = 100;
function fetchLatestLiquidityWithdrawalEventDataByOwner(lyra, owner, market) {
    return __awaiter(this, void 0, void 0, function () {
        var liquidityPoolContract, toBlockNumber, fromBlockNumber, _a, withdrawalQueuedEvents, withdrawalProcessedEvents, liquidityWithdrawalQueuedEvents, liquidityWithdrawalProcessedEvents;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a = _b.sent(), withdrawalQueuedEvents = _a[0], withdrawalProcessedEvents = _a[1];
                    liquidityWithdrawalQueuedEvents = withdrawalQueuedEvents.map(function (event) {
                        return {
                    ...
                    liquidityWithdrawalProcessedEvents = withdrawalProcessedEvents.map(function (event) {
                        return {
...
exports.default = fetchLatestLiquidityWithdrawalEventDataByOwner;
