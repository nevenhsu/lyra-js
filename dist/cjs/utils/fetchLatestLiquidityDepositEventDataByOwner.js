...
var BLOCK_LIMIT = 100;
function fetchLatestLiquidityDepositEventDataByOwner(lyra, owner, market) {
    return __awaiter(this, void 0, void 0, function () {
        var liquidityPoolContract, toBlockNumber, fromBlockNumber, _a, depositQueuedEvents, depositProcessedEvents, liquidityDepositQueuedEvents, liquidityDepositProcessedEvents;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a = _b.sent(), depositQueuedEvents = _a[0], depositProcessedEvents = _a[1];
                    liquidityDepositQueuedEvents = depositQueuedEvents.map(function (event) {
                        return {
                    ...
                    liquidityDepositProcessedEvents = depositProcessedEvents.map(function (event) {
                        return {
...
exports.default = fetchLatestLiquidityDepositEventDataByOwner;
