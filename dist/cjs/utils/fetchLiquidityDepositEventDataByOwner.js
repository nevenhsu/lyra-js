        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    depositQueuedEvents = (_a = userLiquidity.pendingDepositsAndWithdrawals.map(function (queuedDeposit) {
                        return {
                            depositor: owner,
                            beneficiary: owner,
                    ...
                    depositProcessedEvents = (_b = userLiquidity.depositsAndWithdrawals.map(function (processedDeposit) {
                        return {
                            caller: owner,
                            beneficiary: owner,
                    ...
                    depositQueuedEventMap = depositQueuedEvents.reduce(function (map, depositQueuedEvent) {
                        var _a;
                        return (__assign(__assign({}, map), (_a = {}, _a[depositQueuedEvent.queueId] = depositQueuedEvent, _a)));
                    }, {});
                    depositProcessedEventMap = depositProcessedEvents.reduce(function (map, depositProcessedEvent) {
                        var _a;
                        if (depositProcessedEvent.queueId === 0) {
                            return map;
                        }
                        else {
                            return __assign(__assign({}, map), (_a = {}, _a[depositProcessedEvent.queueId] = depositProcessedEvent, _a));
                        }
                    }, {});
                    instantDepositEvents = depositProcessedEvents.map(function (processed) { return ({
                        processed: processed,
                        isProcessed: true,
                        isInstant: true,
                    }); });
                    depositEvents = Object.entries(depositQueuedEventMap).map(function (_a) {
                        var depositQueueId = _a[0], queued = _a[1];
                        var processed = depositProcessedEventMap[parseInt(depositQueueId, 10)];
                        if (processed) {
                            return {
                                queued: queued,
                                processed: processed,
                    ...
                    return [2 /*return*/, {
                            events: instantDepositEvents.concat(depositEvents).sort(function (a, b) {
