...
function fetchPositionEventDataByHash(lyra, transactionHashOrReceipt) {
    return __awaiter(this, void 0, void 0, function () {
        var receipt, _a, transactionHash, tradeEvents, updateEvents, marketAddress, contractAddresses, optionTokenAddress_1, marketContractAddresses, market, positionIds, eventsByPositionID, events, trades, collateralUpdates, transfers, settles;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    tradeEvents = (0, parsePartialTradeEventsFromLogs_1.default)(lyra, receipt.logs);
                    updateEvents = (0, parsePartialPositionUpdatedEventsFromLogs_1.default)(receipt.logs) // Also covers settle events
                    ;
                    marketAddress = null;
                ...
                case 6:
                    ...
                    return [4 /*yield*/, __1.Market.get(lyra, marketAddress)];
                case 7:
                    market = _b.sent();
