...
var NewportOptionMarket_json_1 = __importDefault(require("../contracts/newport/abis/NewportOptionMarket.json"));
...
var getMarketContractABI = function (version, contractId) {
    switch (contractId) {
...
function getLyraMarketContract(lyra, contractAddresses, version, contractId) {
    ...
    var abi = (0, exports.getMarketContractABI)(version, contractId);
