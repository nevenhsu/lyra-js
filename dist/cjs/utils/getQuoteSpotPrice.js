...
function getQuoteSpotPrice(market, priceType) {
    ...
    if (market.lyra.version === lyra_1.Version.Avalon || !market.params.adapterView || priceType === PriceType.REFERENCE) {
        return spotPrice;
    }
    var _a = market.params.adapterView, forceMaxSpotPrice = _a.gmxMaxPrice, forceMinSpotPrice = _a.gmxMinPrice, marketPricingParams = _a.marketPricingParams;
