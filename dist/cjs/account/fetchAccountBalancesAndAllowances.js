                    ...
                    return [4 /*yield*/, Promise.all(markets.map(function (market) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        _a = (_b.sent()).returnData, quoteSymbol = _a[0], quoteDecimals = _a[1], quoteBalance = _a[2], quoteTradeAllowance = _a[3], quoteDepositAllowance = _a[4], baseSymbol = _a[5], baseDecimals = _a[6], baseBalance = _a[7], baseTradeAllowance = _a[8], liquidityBalance = _a[9];
                                        return [2 /*return*/, {
                                                owner: owner,
                                                market: market,
