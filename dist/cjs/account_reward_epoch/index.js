...
var AccountRewardEpoch = /** @class */ (function () {
    function AccountRewardEpoch(lyra, account, accountEpoch, globalEpoch, balances, lyraBalances, claimAddedEvents, claimEvents, rewardTokens, totalClaimableRewards) {
        var _this = this;
        var _a, _b;
        this.lyra = lyra;
        ...
        var avgStkLyraBalance = globalEpoch.progressDays > 0 ? accountEpoch.stakingRewards.stkLyraDays / globalEpoch.progressDays : 0;
        this.stakedLyraBalance = globalEpoch.isComplete
            ? avgStkLyraBalance
            : (0, fromBigNumber_1.default)(lyraBalances.ethereumStkLyra.add(lyraBalances.optimismStkLyra).add(lyraBalances.arbitrumStkLyra));
        this.vaultTokenBalancesMap = balances.reduce(function (lpTokenBalances, balance) {
            var _a;
            return (__assign(__assign({}, lpTokenBalances), (_a = {}, _a[balance.baseAsset.symbol] = balance.liquidityToken, _a)));
        }, {});
        this.tradingFeeRebate = globalEpoch.tradingFeeRebate(this.stakedLyraBalance);
        var integratorTradingFees = (_b = (_a = accountEpoch.integratorTradingRewards) === null || _a === void 0 ? void 0 : _a.fees) !== null && _b !== void 0 ? _b : 0;
    ...
    // Getters
    AccountRewardEpoch.getByOwner = function (lyra, address) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, accountEpochDatas, globalEpochs, lyraBalances, balances, claimAddedEvents, claimEvents, uniqueRewardTokens, distributorContract, returnData, totalClaimableBalances;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                (0, fetchAccountRewardEpochData_1.default)(lyra, address),
                                global_reward_epoch_1.GlobalRewardEpoch.getAll(lyra),
                                lyra.account(address).lyraBalances(),
                                lyra.account(address).balances(),
                                (0, fetchClaimAddedEvents_1.default)(lyra, lyra.chain, address),
                                (0, fetchClaimEvents_1.default)(lyra, lyra.chain, address),
                            ])];
                    case 1:
                        _a = _b.sent(), accountEpochDatas = _a[0], globalEpochs = _a[1], lyraBalances = _a[2], balances = _a[3], claimAddedEvents = _a[4], claimEvents = _a[5];
    ...
    // Dynamic Fields
    AccountRewardEpoch.prototype.vaultApy = function (marketAddressOrName) {
        var vaultTokenBalance = this.vaultTokenBalance(marketAddressOrName);
    ...
    AccountRewardEpoch.prototype.vaultMaxBoost = function (marketAddressOrName) {
        var vaultTokenBalance = this.vaultTokenBalance(marketAddressOrName);
        if (vaultTokenBalance === 0) {
    ...
    AccountRewardEpoch.prototype.vaultApyMultiplier = function (marketAddressOrName) {
        var vaultTokenBalance = this.vaultTokenBalance(marketAddressOrName);
        if (vaultTokenBalance === 0) {
            return 1;
        }
    ...
    AccountRewardEpoch.prototype.vaultTokenBalance = function (marketAddressOrName) {
        var _a, _b;
        var market = (0, findMarketX_1.default)(this.globalEpoch.markets, marketAddressOrName);
        var marketKey = market.baseToken.symbol;
        var boostedLpDays = this.accountEpoch.mmvRewards
            ? (_b = (_a = this.accountEpoch.mmvRewards[marketKey]) === null || _a === void 0 ? void 0 : _a.boostedLpDays) !== null && _b !== void 0 ? _b : 0
            : 0;
        var avgVaultTokenBalance = this.globalEpoch.progressDays > 0 ? boostedLpDays / this.globalEpoch.progressDays : 0;
        var currVaultTokenBalance = (0, fromBigNumber_1.default)(this.vaultTokenBalancesMap[marketKey].balance);
        // Uses average for historical epochs, realtime for current epoch
        var vaultTokenBalance = this.globalEpoch.isComplete ? avgVaultTokenBalance : currVaultTokenBalance;
