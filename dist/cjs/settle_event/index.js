...
var SettleEvent = /** @class */ (function () {
    function SettleEvent(lyra, settle) {
        this.lyra = lyra;
    ...
    // Getters
    SettleEvent.getByHash = function (lyra, transactionHashOrReceipt) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        settles = (_a.sent()).settles;
                        return [2 /*return*/, settles];
                }
            });
        });
    };
    // Dynamic Fields
    SettleEvent.prototype.pnl = function (position) {
        return position.pnl().settlementPnl;
    };
    // Edges
    SettleEvent.prototype.position = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lyra.position(this.marketAddress, this.positionId)];
