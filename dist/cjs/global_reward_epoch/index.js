...
var getEffectiveTradingFeeRebate_1 = __importDefault(require("../utils/getEffectiveTradingFeeRebate"));
...
var GlobalRewardEpoch = /** @class */ (function () {
    function GlobalRewardEpoch(lyra, id, epoch, markets, marketsLiquidity, stakingParams, block) {
        var _a, _b, _c, _d, _e;
        this.lyra = lyra;
        this.id = id;
        this.epoch = epoch;
        ...
        this.tradingFeeRebateTiers = (_b = (_a = epoch.tradingRewardConfig) === null || _a === void 0 ? void 0 : _a.rebateRateTable) === null || _b === void 0 ? void 0 : _b.map(function (tier) { return ({
        ...
        // Trading
        var totalStkLyra = this.isComplete ? this.totalAverageStakedLyra : (0, fromBigNumber_1.default)(stakingParams.totalSupply);
    ...
    GlobalRewardEpoch.getAll = function (lyra) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, epochs, stakingParams, markets, block, marketsLiquidity;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                (0, fetchLyraStakingParams_1.default)(lyra),
                                lyra.markets(),
                                lyra.provider.getBlock('latest'),
                            ])];
                    case 1:
                        _a = _b.sent(), epochs = _a[0], stakingParams = _a[1], markets = _a[2], block = _a[3];
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, epochs
                                .map(function (epoch, idx) { return new GlobalRewardEpoch(lyra, idx + 1, epoch, markets, marketsLiquidity, stakingParams, block); })
    ...
    GlobalRewardEpoch.prototype.vaultApy = function (marketAddressOrName, stakedLyraBalance, vaultTokenBalance) {
        ...
        var totalAvgBoostedVaultTokens = this.totalAverageBoostedVaultTokens(marketAddressOrName);
        var boostedPortionOfLiquidity = totalAvgBoostedVaultTokens > 0 ? effectiveLpTokensPerLpToken / totalAvgBoostedVaultTokens : 0;
        var basePortionOfLiquidity = totalAvgVaultTokens > 0 ? vaultTokenBalance / totalAvgVaultTokens : 0;
        ...
        var apyMultiplier = basePortionOfLiquidity > 0 ? boostedPortionOfLiquidity / basePortionOfLiquidity : 0;
    ...
    GlobalRewardEpoch.prototype.tradingFeeRebate = function (stakedLyraBalance) {
        var _a = this.epoch.tradingRewardConfig, useRebateTable = _a.useRebateTable, rebateRateTable = _a.rebateRateTable, maxRebatePercentage = _a.maxRebatePercentage, netVerticalStretch = _a.netVerticalStretch, verticalShift = _a.verticalShift, vertIntercept = _a.vertIntercept, stretchiness = _a.stretchiness;
        return (0, getEffectiveTradingFeeRebate_1.default)(stakedLyraBalance, useRebateTable, rebateRateTable, maxRebatePercentage, netVerticalStretch, verticalShift, vertIntercept, stretchiness);
    };
    GlobalRewardEpoch.prototype.tradingRewards = function (tradingFees, stakedLyraBalance) {
        var _this = this;
        return this.epoch.tradingRewardConfig.tokens
            .map(function (token) {
            var _a, _b;
            var currentPrice = (_b = (_a = _this.tokenPriceMap[token.address]) === null || _a === void 0 ? void 0 : _a.price) !== null && _b !== void 0 ? _b : 0;
            var price = _this.isComplete ? token.fixedPrice : Math.max(currentPrice, token.floorTokenPrice);
            var feeRebate = _this.tradingFeeRebate(stakedLyraBalance);
            var feesRebated = feeRebate * tradingFees;
            var rewardAmount = (feesRebated * token.portion) / price;
            return {
                amount: rewardAmount,
                address: token.address,
                decimals: token.decimals,
            ...
            .filter(function (e) { return e.amount > rewards_1.MIN_REWARD_AMOUNT; });
    };
    // Edge
