...
function getPositionPnl(position) {
    ...
    if (!trades.length) {
        return {
            totalAverageOpenCost: bn_1.ZERO_BN,
            totalAverageCloseCost: bn_1.ZERO_BN,
            unrealizedPnl: bn_1.ZERO_BN,
            unrealizedPnlPercentage: bn_1.ZERO_BN,
            realizedPnl: bn_1.ZERO_BN,
            realizedPnlPercentage: bn_1.ZERO_BN,
            settlementPnl: bn_1.ZERO_BN,
            settlementPnlPercentage: bn_1.ZERO_BN,
        };
    }
