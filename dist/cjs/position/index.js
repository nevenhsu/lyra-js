...
exports.Position = exports.PositionLeaderboardSortBy = void 0;
...
var fetchAllPositionData_1 = __importDefault(require("../utils/fetchAllPositionData"));
...
var PositionLeaderboardSortBy;
(function (PositionLeaderboardSortBy) {
    PositionLeaderboardSortBy["RealizedPnl"] = "RealizedPnl";
    PositionLeaderboardSortBy["RealizedLongPnl"] = "RealizedLongPnl";
    PositionLeaderboardSortBy["RealizedLongPnlPercentage"] = "RealizedLongPnlPercentage";
    PositionLeaderboardSortBy["UnrealizedPnl"] = "UnrealizedPnl";
    PositionLeaderboardSortBy["UnrealizedLongPnl"] = "UnrealizedLongPnl";
    PositionLeaderboardSortBy["UnrealizedLongPnlPercentage"] = "UnrealizedLongPnlPercentage";
})(PositionLeaderboardSortBy = exports.PositionLeaderboardSortBy || (exports.PositionLeaderboardSortBy = {}));
var Position = /** @class */ (function () {
    ...
    Position.getAll = function (lyra, filter) {
        return __awaiter(this, void 0, void 0, function () {
            var positions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchAllPositionData_1.default)(lyra, filter)];
                    case 1:
                        positions = _a.sent();
    ...
    Position.getOpenByOwner = function (lyra, owner) {
        return __awaiter(this, void 0, void 0, function () {
            var markets, positions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, lyra.markets()];
                    case 1:
                        markets = _a.sent();
                        return [4 /*yield*/, (0, fetchOpenPositionDataByOwner_1.default)(lyra, owner, markets)];
                    case 2:
                        positions = _a.sent();
                        return [2 /*return*/, positions.map(function (position) { return new Position(lyra, position); })];
                }
    ...
    Position.prototype.firstTrade = function () {
        var _a;
        return (_a = this.trades()[0]) !== null && _a !== void 0 ? _a : null;
    };
    Position.prototype.lastTrade = function () {
        var _a;
        var trades = this.trades();
        return (_a = trades[trades.length - 1]) !== null && _a !== void 0 ? _a : null;
    };
