...
var Trade = /** @class */ (function () {
    ...
    // Helper Functions
    Trade.getPositionIdsForLogs = function (lyra, logs) {
        var trades = (0, parsePartialTradeEventsFromLogs_1.default)(lyra, logs);
        var updates = (0, parsePartialPositionUpdatedEventsFromLogs_1.default)(logs);
    ...
    Trade.getEventsForLogs = function (lyra, logs) {
        var trades = (0, parsePartialTradeEventsFromLogs_1.default)(lyra, logs);
        var updates = (0, parsePartialPositionUpdatedEventsFromLogs_1.default)(logs);
