...
var getDefaultVersionForChain_1 = __importDefault(require("./utils/getDefaultVersionForChain"));
...
var getLyraGovernanceSubgraphURI_1 = __importDefault(require("./utils/getLyraGovernanceSubgraphURI"));
...
var Lyra = /** @class */ (function () {
    function Lyra(config) {
        ...
        if (typeof config === 'object') {
            ...
            this.apiUri = (_a = configObj.apiUri) !== null && _a !== void 0 ? _a : links_1.LYRA_API_URL;
            this.version = (_b = config.version) !== null && _b !== void 0 ? _b : (0, getDefaultVersionForChain_1.default)(this.chain);
            this.subgraphUri = (_c = configObj === null || configObj === void 0 ? void 0 : configObj.subgraphUri) !== null && _c !== void 0 ? _c : (0, getLyraDeploymentSubgraphURI_1.default)(this.chain, this.version);
            this.govSubgraphUri = (_d = configObj === null || configObj === void 0 ? void 0 : configObj.govSubgraphUri) !== null && _d !== void 0 ? _d : (0, getLyraGovernanceSubgraphURI_1.default)(this.chain);
        }
        else if (typeof config === 'number') {
            // Chain ID
            this.chain = (0, getLyraChainForChainId_1.default)(config);
            this.provider = (0, getLyraDeploymentProvider_1.default)(this.chain);
            this.version = (0, getDefaultVersionForChain_1.default)(this.chain);
            this.subgraphUri = (0, getLyraDeploymentSubgraphURI_1.default)(this.chain, this.version);
            this.govSubgraphUri = (0, getLyraGovernanceSubgraphURI_1.default)(this.chain);
        }
        else {
            // String
            this.chain = config;
        ...
        this.govSubgraphClient = new core_1.ApolloClient({
            connectToDevTools: true,
            link: new core_1.HttpLink({ uri: this.govSubgraphUri, fetch: cross_fetch_1.default }),
            cache: new core_1.InMemoryCache(),
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        market = _a.sent();
                        return [4 /*yield*/, liquidity_deposit_1.LiquidityDeposit.getByOwner(this, market, owner)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        market = _a.sent();
                        return [4 /*yield*/, liquidity_withdrawal_1.LiquidityWithdrawal.getByOwner(this, market, owner)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    // Rewards
    Lyra.prototype.claimRewards = function (owner, tokenAddresses) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, account_reward_epoch_1.AccountRewardEpoch.claim(this, owner, tokenAddresses)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Lyra.prototype.accountRewardEpochs = function (owner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, account_reward_epoch_1.AccountRewardEpoch.getByOwner(this, owner)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
