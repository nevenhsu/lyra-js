...
var fetchNewportOptimismMarketViews_1 = __importDefault(require("../utils/fetchNewportOptimismMarketViews"));
...
var Market = /** @class */ (function () {
    function Market(lyra, marketView, isGlobalPaused, owner, tokenPrice, block, hedgerView, adapterView, poolHedgerParams, baseLimit) {
        this.__source = contracts_1.DataSource.ContractCall;
        this.lyra = lyra;
        this.block = block;
        this.__data = marketView;
        var fields = Market.getFields(lyra.version, lyra.network, marketView, isGlobalPaused, owner, tokenPrice, hedgerView, adapterView, poolHedgerParams);
    ...
    Market.getFields = function (version, network, marketView, isGlobalPaused, owner, tokenPrice, hedgerView, adapterView, poolHedgerParams, baseLimit) {
        var _a;
        ...
        if (version === lyra_1.Version.Avalon) {
            ...
            var newportMarketView = void 0;
            switch (network) {
                case network_1.Network.Arbitrum:
                    ...
                    break;
                case network_1.Network.Optimism:
                    if (!adapterView) {
                        throw new Error('Adapter or hedger view does not exist');
                    }
                    newportMarketView = marketView;
                    ...
                    baseSymbol = newportMarketView.baseSymbol;
                    baseDecimals = newportMarketView.baseDecimals.toNumber();
                    params = __assign({ rateAndCarry: adapterView.riskFreeRate, referenceSpotPrice: spotPrice }, sharedParams);
            }
        }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3: return [4 /*yield*/, Promise.all([
                            lyra.network === network_1.Network.Arbitrum ? (0, fetchNewportMarketViews_1.default)(lyra) : (0, fetchNewportOptimismMarketViews_1.default)(lyra),
                            lyra.provider.getBlock('latest'),
                        ])];
                    case 4:
                        ...
                        markets = marketViews.map(function (_a) {
                            var marketView = _a.marketView, hedgerView = _a.hedgerView, adapterView = _a.adapterView, poolHedgerParams = _a.poolHedgerParams, tokenPrice = _a.tokenPrice, baseLimit = _a.baseLimit;
                            return new Market(lyra, marketView, isGlobalPaused_1, owner_1, tokenPrice, block_2, hedgerView, adapterView, poolHedgerParams, baseLimit);
                        });
    ...
    Market.prototype.deposits = function (owner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, liquidity_deposit_1.LiquidityDeposit.getByOwner(this.lyra, this, owner)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Market.prototype.withdrawals = function (owner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, liquidity_withdrawal_1.LiquidityWithdrawal.getByOwner(this.lyra, this, owner)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
