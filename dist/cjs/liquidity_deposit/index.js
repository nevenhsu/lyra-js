...
exports.LiquidityDeposit = exports.LiquidityDelayReason = void 0;
var contracts_1 = require("../constants/contracts");
var market_1 = require("../market");
var buildTx_1 = __importDefault(require("../utils/buildTx"));
var fetchLiquidityDepositEventDataByOwner_1 = __importDefault(require("../utils/fetchLiquidityDepositEventDataByOwner"));
...
})(LiquidityDelayReason = exports.LiquidityDelayReason || (exports.LiquidityDelayReason = {}));
var LiquidityDeposit = /** @class */ (function () {
    function LiquidityDeposit(lyra, market, data) {
        // Data
        this.lyra = lyra;
    ...
    // Getters
    LiquidityDeposit.getByOwner = function (lyra, marketAddress, owner) {
        return __awaiter(this, void 0, void 0, function () {
            var market, liquidityPoolContract, _a, events, cbTimestamp, marketLiquidity, liquidityDeposits;
            var _this = this;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all([
                                (0, fetchLiquidityDepositEventDataByOwner_1.default)(lyra, owner, market),
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.all(events.map(function (event) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    return [2 /*return*/, new LiquidityDeposit(lyra, market, __assign(__assign({}, event), { cbTimestamp: cbTimestamp, marketLiquidity: marketLiquidity }))];
                                });
                            }); }))];
                    case 3:
                        liquidityDeposits = _b.sent();
    ...
    // Transactions
    LiquidityDeposit.approve = function (market, owner, amountQuote) {
        ...
        var data = erc20.interface.encodeFunctionData('approve', [liquidityPoolContract.address, amountQuote]);
        return (0, buildTx_1.default)(market.lyra.provider, market.lyra.provider.network.chainId, erc20.address, owner, data);
    };
    LiquidityDeposit.initiateDeposit = function (market, beneficiary, amountQuote) {
        var liquidityPoolContract = (0, getLyraMarketContract_1.default)(market.lyra, market.contractAddresses, market.lyra.version, contracts_1.LyraMarketContractId.LiquidityPool);
        var data = liquidityPoolContract.interface.encodeFunctionData('initiateDeposit', [beneficiary, amountQuote]);
    ...
    // Edges
    LiquidityDeposit.prototype.market = function () {
