...
var LiquidityDeposit = /** @class */ (function () {
    function LiquidityDeposit(lyra, data) {
        // Data
        this.lyra = lyra;
        ...
        var queuedOrProcessed = (data.events.isInstant ? processed : data.events.queued);
    ...
    // Getters
    LiquidityDeposit.getByOwner = function (lyra, market, owner) {
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        liquidityDeposits = events.map(function (events) {
                            return new LiquidityDeposit(lyra, {
                                market: market,
                                events: events,
