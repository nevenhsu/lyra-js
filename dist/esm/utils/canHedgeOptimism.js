...
const hasEnoughMarketDepth = (hedge, maxTotalMarketSize, marketDepthBuffer, shortInterest, longInterest) => {
...
export default function canHedgeOnOptimism(spotPrice, netDelta, option, size, increasesPoolDelta, hedgerView, poolHedgerParams) {
    const { marketSuspended, hedgedDelta: currentHedge, futuresPoolHedgerParams, fundingRate, shortInterest, longInterest, maxTotalMarketSize, curveRateStable, } = hedgerView;
    if (marketSuspended) {
        return false;
    }
