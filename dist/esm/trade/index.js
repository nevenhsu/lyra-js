...
export class Trade {
    constructor(lyra, owner, option, isBuy, size, slippage, balances, options) {
        ...
        const { position, setToCollateral = ZERO_BN, setToFullCollateral = false, iterations = DEFAULT_ITERATIONS, isBaseCollateral: _isBaseCollateral, } = options !== null && options !== void 0 ? options : {};
    ...
    // Helper Functions
    static getPositionIdsForLogs(lyra, logs) {
    ...
    static getEventsForLogs(lyra, logs) {
        const trades = parsePartialTradeEventsFromLogs(lyra, logs);
        const updates = parsePartialPositionUpdatedEventsFromLogs(logs);
