...
export class GlobalRewardEpoch {
    constructor(lyra, id, epoch, markets, marketsLiquidity, block) {
        var _a, _b, _c, _d, _e;
        this.lyra = lyra;
        this.id = id;
        this.epoch = epoch;
        ...
        this.tradingBoostTiers = (_b = (_a = epoch.tradingRewardConfig) === null || _a === void 0 ? void 0 : _a.boostRateTable) === null || _b === void 0 ? void 0 : _b.map(tier => ({
